...
/**
 * This is the item provider adapter for a {@link Trmodel.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrmodelPackage.Literals.COLUMN__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTableNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_tableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_tableName_feature", "_UI_Column_type"),
				 TrmodelPackage.Literals.COLUMN__TABLE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Column.class)) {
			case TrmodelPackage.COLUMN__NAME:
			case TrmodelPackage.COLUMN__TABLE_NAME:
